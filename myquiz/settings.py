...
SECRET_KEY = 'django-insecure-cjy!^__aihkx8m_=%4y$vqn%!43kps$q1^6@k*9*so8capc)!t'
...
MIDDLEWARE = [
    ...
    'myquizz.middleware.NoBackButtonMiddleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'myquizdb',                    # Name of your database
        'USER': 'myquizuser',                  # Database username
